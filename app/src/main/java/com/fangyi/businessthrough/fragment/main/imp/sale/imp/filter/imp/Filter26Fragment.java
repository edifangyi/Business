package com.fangyi.businessthrough.fragment.main.imp.sale.imp.filter.imp;
...
import com.fangyi.businessthrough.adapter.business.MenuFilterXsFragmentAdapter;
...
public class Filter26Fragment extends BaseFragment {

    private static final int ADD_HISTORY_CUSTOMER_REQ_CODE = 4;//搜索添加历史订单客户
    private static final int THE_CALLBACK_TO_REFRESH = 10;//回调刷新
    ...
    private MenuFilterXsFragmentAdapter mAdapter;
    private List<PrintOrderMain> orderMainList = new ArrayList<>();
    ...
    public Filter26Fragment() {

    }

    public static Filter26Fragment getInstance(String s) {
        Filter26Fragment newFragment = new Filter26Fragment();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    if (mAdapter == null) {
                        mAdapter = new MenuFilterXsFragmentAdapter(orderMainList);
...
//            public void run() {
        ...
        orderMainList.clear();
        orderMainList.addAll(dbManager.getOrderList(businessType, condition));
        ...
        if (orderMainList.size() == 0) {
            ...
            for (PrintOrderMain orderMain : orderMainList) {
    ...
    private OnSwipeMenuItemClickListener menuItemClickListener = new OnSwipeMenuItemClickListener() {
        ...
        public void onItemClick(Closeable closeable, final int adapterPosition, int menuPosition, int direction) {
            ...
            if (direction == SwipeMenuRecyclerView.LEFT_DIRECTION && menuPosition == 0) {
                String fUpdateType = orderMainList.get(adapterPosition).updateType;
            ...
            if (direction == SwipeMenuRecyclerView.RIGHT_DIRECTION && menuPosition == 0) {// 删除按钮被点击。
                ...
                switch (orderMainList.get(adapterPosition).delType) {
                    case "0":
