...
public class FEntry27Fragment extends BaseFragment {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 4:
                    ...
                    KLog.e("=======" + seOrderMain.getOrderGoods().toString());
                    KLog.e("=======" + seOrderMain.getPresentGoods().toString());

                    Data.ArrangeSEOrder(seOrderMain, goodsInfos, goodsPromotionInfos);


                    KLog.e("@@@@@@@@@@@@@@@@========" + goodsInfos.toString());
                    KLog.e("@@@@@@@@@@@@@@@@========" + goodsPromotionInfos.toString());
    ...
    public FEntry27Fragment() {

    }

    public static FEntry27Fragment getInstance(String s) {
        FEntry27Fragment newFragment = new FEntry27Fragment();
    ...
    protected View getSuccessView() {
        ...
        CommonUtils.setSaleTitle(getActivity(), "销售出库单");
    ...
    private void readingData() {
        ...
        fEntry27Set = manager.getFEntry_27_Set(new String[]{LoginUser.userSysID, "销售出库单"});
        manager.closeDB();
    ...
    private void setinitItemView() {
        ...
        fyFAreaPS.setTitle("业务类型");
        fyFAreaPS.setContent(map.get(fEntry27Set.fBizTypeD));//默认
        ...
        fyFSaleStyle.setContent(map.get(fEntry27Set.fSaleStyleD));//默认
        ...
        fyFDept.setTitle("部门");
        fyFDept.setContent(mapDepartment.get(fEntry27Set.fDeptD));
        if ("0".equals(fEntry27Set.fDeptV)) {
            fyFDept.setVisibility(View.GONE);
        }

        fyFDCStock.setTitle("仓库");
        fyFDCStock.setContent(mapWareHouse.get(fEntry27Set.fDCStockD));
    ...
    private OnItemClickListener onItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(final int position) {
            ...
            if ("1".equals(fEntry27Set.fChooseAmount)) {//可以改价格
                fyPrice.setTitle("单价");
    ...
    private void over(int position) {
        ...
        if ("1".equals(fEntry27Set.fChooseAmount)) {//更改单价金额
    ...
    private void setListener() {
        ...
        //允许选择日期
        if ("1".equals(fEntry27Set.fChooseDate)) {
    ...
    private void uploadOrder() {
        ...
        if ("上传失败".equals(result)) {
            ...
            if ("2".equals(fEntry27Set.fDelType)) {//上传后不可以修改
                setClickEvent(false);
            }
        }
    }
    ...
    private void setBtnPrint() {
        ...
        if ("1".equals(fEntry27Set.fDelType)) {//打印后不可以修改
            setClickEvent(false);
        }
    }
...
//        }
    ...
    private void saveSettings() {
        ...
        if ("0".equals(fEntry27Set.fSaFePrint)) {//保存后立刻打印
        ...
        if ("0".equals(fEntry27Set.fUpdateType)) {//保存后不可以修改
            setClickEvent(false);
        }
    }
    ...
    private void save() {
        ...
        String FUpdateType = fEntry27Set.fUpdateType; //修改控制
        String FDelType = fEntry27Set.fDelType; //删除控制
        ...
        isSaveOrder = "1";
        CommonUtils.setSaleTitle(getActivity(), "销售出库（已保存）");
//
//        //更改源单标识，保存选择以后不会再去关联
//        DBBusiness business = new DBBusiness(getContext());
...
//        business.closeDB();
    ...
    private void startAddDonation() {
        ...
        if (fyFCustNameID != null) {
            ...
            intent.putExtra("fChooseAmount", fEntry27Set.fChooseAmount);//允许修改单价金额
            intent.putExtra("fDCStockD", fEntry27Set.fDCStockD);//仓库
            intent.putExtra("fStockPosition", fEntry27Set.fStockPosition);//仓库 在添加页面
            intent.putExtra("fPlanPro", fEntry27Set.fPlanPro);//启用搭赠方案
    ...
    private void setFDCStock() {
        ...
        if (!"1".equals(fEntry27Set.fCheckType)) {
    ...
    private void setFAreaPS() {
        ...
        if (!fEntry27Set.fCheckType.equals("1")) {
            //滑动
...
//            btnPrint1.setEnabled(true);
    ...
    private String printOrder() {
        ...
        manager.closeDB();
        int pageSize = Integer.valueOf(fEntry27Set.fPrintSame);
        switch (pageSize) {
            case 0:
