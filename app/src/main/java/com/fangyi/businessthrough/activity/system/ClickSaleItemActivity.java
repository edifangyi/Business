 ...
 */
public class ClickSaleItemActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ft.replace(R.id.fl_click_button, FragmentFactory.createBySaleItem(resId, item));
        ft.commit();

        actionBarBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClickSaleItemActivity.this.finish();
            }
        });
    }
