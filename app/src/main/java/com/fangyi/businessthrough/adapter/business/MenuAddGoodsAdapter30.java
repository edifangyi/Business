 ...
 */
public class MenuAddGoodsAdapter30 extends SwipeMenuAdapter<MenuAddGoodsAdapter30.DefaultViewHolder> {


    private List<AddGoodsMessage30> goodsInfos;
    private OnItemClickListener mOnItemClickListener;

    public MenuAddGoodsAdapter30(List<AddGoodsMessage30> goodsInfos) {
    ...
    public void onBindViewHolder(DefaultViewHolder holder, int position) {
        ...
        AddGoodsMessage30 message = goodsInfos.get(position);
