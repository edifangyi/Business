 ...
 */
public class MenuFilterXsFragmentAdapter extends SwipeMenuAdapter<MenuFilterXsFragmentAdapter.DefaultViewHolder> {


    private List<PrintOrderMain> orderMainList;
    private OnItemClickListener mOnItemClickListener;

    public MenuFilterXsFragmentAdapter(List<PrintOrderMain> orderMainList) {
    ...
    public void onBindViewHolder(DefaultViewHolder holder, int position) {
        ...
        PrintOrderMain orderMain = orderMainList.get(position);

        holder.setTvName(orderMain.customerName);
        holder.setTvWarehouse(orderMain.wareHouseName);
        holder.setTvAllmoney(orderMain.allMoney);
        holder.setTvTime(orderMain.orderDate);
