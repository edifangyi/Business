...
public abstract class BaseNoScrollViewPagerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.viewpager_view_indicator, null);
    ...
    protected void setIndicator() {
        ...
        indicator.setDividerPadding(CommonUtils.dip2px(FYApplication.getContext(), 10));
        indicator.setIndicatorColor(Color.parseColor("#11B6F4"));// 设置底部横线的颜色
        indicator.setTextColorSelected(Color.parseColor("#11B6F4"));// 设置tab标题选中的颜色
        indicator.setTextColor(Color.parseColor("#797979"));// 设置tab标题未被选中的颜色
        indicator.setTextSize(CommonUtils.sp2px(FYApplication.getContext(), 16));// 设置字体大小
    }
